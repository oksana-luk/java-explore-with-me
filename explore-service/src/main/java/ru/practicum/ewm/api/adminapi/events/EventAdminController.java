...
public class EventAdminController {
    ...
    public List<EventFullDto> getEvents(@RequestParam(name = "users") List<Long> users,
                                        @RequestParam(name = "states") List<Event.State> states,
                                        @RequestParam(name = "categories") List<Long> categories,
                                        @RequestParam(name = "rangeStart") @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime start,
                                        @RequestParam(name = "rangeEnd") @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime end,
    ...
    public EventFullDto updateEvent(@Valid @RequestBody UpdateEventAdminRequest updateEventAdminRequest,
        ...
        log.info("PATCH /admin/events eventId={}, updateEventAdminRequest={}", eventId, updateEventAdminRequest);
        ...
        log.info("PATCH /admin/events result={}", eventFullDto);
        return eventFullDto;
    }
}
